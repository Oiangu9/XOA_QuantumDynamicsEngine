...
if [[ $psi == *"GS"* ]]; then
    ...
    START_TIME=$SECONDS
        ...
        set origin -0.007,0.0; set size 0.167, 0.33; clear; set key title 'R^4 G_x(x,y,t) for this trajectory KA y(t)'; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-2e-6<*:*<2e-6]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t/2 using 1:2:3 title 'Full WF R^4 G_x(x,y,t)'; unset pm3d; unset view; unset colorbox; unset key;
        ...
        set origin 0.167,0.0; set size 0.166, 0.33; clear;  set xtics auto; set key title 'R^4 J_x(x,y,t) for this trajectory KA y(t)' at 1,31; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-2e-6<*:*<2e-6]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t/2 using 1:2:4 title 'Full WF R^4 J_x(x,y,t)'; unset pm3d; unset view; unset colorbox; unset key;
        ...
        set origin 0.33, 0.33; set size 0.166, 0.33; clear; set xrange [$x2min:$x2max]; set yrange [0:0.013]; set key title 'y Conditional Wave Function Probability Density';  set xlabel 'Position y'; set ylabel 'Probab Density'; plot 'DATA_probabilityToPlot_2D_XO_KinAdv_BornHuang_tINDEP.txt' index (t+1) using (posx2[\$0+1]):1 title columnheader(1) w l, 'DATA_probDensity_conditional_WF_CN.txt' index (t+1) using (posx2CN[\$0+1]):1 title columnheader(1) w l, 'DATA_trajectoriesToPlot_2D_XO_CN_KinAdv_BornHuang_tINDEP_k=$k0.txt' using 2:3 every ::(t/2)::(t/2+2) title 'y component of the Trajectory' w points lt 5 pt 6 ps 2 lc rgb 'red';
        set origin 0.34, 0.0; set size 0.167, 0.33; clear; set key title ' ' inside; set xrange [$x1min:$x1max]; set xlabel 'Position x'; set ylabel 'G(x)'; set y2tics nomirror; set y2label 'J(x)'; set yrange [-2e-6<*:*<2e-6]; set y2range [-2e-6<*:*<2e-6]; plot 'DATA_G_J_with_CN_and_KA_trajs.txt' index t/2 using (posx1CN[\$0+1]):1 title 'R^4 G(x) CN with KA trajs' axes x1y1 w l lc rgb 'red', 'DATA_G_J_with_CN_and_KA_trajs.txt' index t/2 using (posx1CN[\$0+1]):2 title 'R^4 J(x) CN with KA trajs' axes x1y2 w l lc rgb 'blue'; unset y2tics; unset y2label; unset key;
        set origin 0.5, 0.66; set size 0.166, 0.33; clear;  set key title; set xrange [$x1min:$x1max]; set xlabel 'Position x'; set ylabel 'Re{U^j(x,t)}'; set y2tics nomirror; set y2label 'Im{U^j(x,t)}'; set y2range [-7.5:7.5]; set yrange [-7.5:7.5]; plot for [i=2:($jmax+1)] 'DATA_XO_Re_Uj.txt' index t/2 using (posx1[\$0+1]):i title sprintf('KA Re{U^{%d}(x,t)}',i-1) axes x1y1 w l, for [i=2:($jmax+1)] 'DATA_CN_Re_Uj.txt' index t/2 using (posx1CN[\$0+1]):i title sprintf('CN Re{U^{%d}(x,t)}',i-1) axes x1y1 w l, for [i=2:($jmax+1)] 'DATA_XO_Im_Uj.txt' index t/2 using (posx1[\$0+1]):i title sprintf('KA Im{U^{%d}(x,t)}',i-1) axes x1y2 w l, for [i=2:($jmax+1)] 'DATA_CN_Im_Uj.txt' index t/2 using (posx1CN[\$0+1]):i title sprintf('CN Im{U^{%d}(x,t)}',i-1) axes x1y2 w l; unset y2tics; unset y2label;
        set origin 0.5, 0.33; set size 0.166, 0.33; clear; set key title ' ' inside; set xrange [$x1min:$x1max]; set yrange [-0.7:0.7]; set xlabel 'Position x'; set ylabel 'Kin'; set y2tics nomirror; set y2label 'Adv'; set y2range [-0.7:0.7]; plot 'DATA_KinAdv_x.txt' index t/2 using (posx1[\$0+1]):1 title 'Re{Kin(x)}' axes x1y1 w l, 'DATA_KinAdv_x.txt' index t/2 using (posx1[\$0+1]):2 title 'Im{Kin(x)}' axes x1y1 w l, 'DATA_KinAdv_x.txt' index t/2 using (posx1[\$0+1]):3 title 'Re{Adv(x)}' axes x1y2 w l, 'DATA_KinAdv_x.txt' index t/2 using (posx1[\$0+1]):4 title 'Im{Adv(x)}' axes x1y2 w l; unset y2tics; unset y2label;
        set origin 0.5, 0.0; set size 0.166, 0.33; clear; set key title ' ' inside; set xrange [$x1min:$x1max]; set yrange [-0.1:0.1]; set xlabel 'Position x'; set ylabel 'G(x)'; set y2tics nomirror; set y2label 'J(x)'; set y2range [-0.1:0.1]; plot 'DATA_G_J_x_KA.txt' index t/2 using (posx1[\$0+1]):1 title 'G(x) KA aprox' axes x1y1 w l lc rgb 'red', 'DATA_G_J_x_KA.txt' index t/2 using (posx1[\$0+1]):2 title 'J(x) KA aprox' axes x1y2 w l lc rgb 'blue'; unset y2tics; unset y2label; unset key;
        set origin 0.65,0.66; set size 0.166, 0.33; clear; set xtics auto; set key title 'R^2 dS_{dy}' at 1,31; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.01<*:*<0.01]; set colorbox user origin 0.795,0.72 size 0.005,0.23; splot 'DATA_Full_WF_G_J_CN.txt' index t/2 using 1:2:5 title 'Full WF R^2 dS_{dy}'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.65,0.33; set size 0.167, 0.33; clear; set xtics auto; set key title 'R^2 d2S_{dy}' at 1,31; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.01<*:*<0.01]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t/2 using 1:2:6 title 'Full WF R^2 d2S_{dy}'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.825,0.66; set size 0.166, 0.33; clear; set xtics auto; set key title 'dR_{dy}' at 1,31; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.01<*:*<0.01]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t/2 using 1:2:7 title 'Full WF dR_{dy}'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.825,0.33; set size 0.167, 0.33; clear; set xtics auto; set key title 'd2R_{dy}' at 1,31; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.01<*:*<0.01]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t/2 using 1:2:8 title 'Full WF d2R_{dy}'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.65,0.0; set size 0.166, 0.33; clear; set xtics auto; set key title 'G_x(x,y,t)' at 1,31; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.08<*:*<0.08]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t/2 using 1:2:9 title 'Full WF G_x(x,y,t)'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.825,0.0; set size 0.167, 0.33; clear; set xtics auto; set key title 'J_x(x,y,t)' at 1,31; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.08<*:*<0.08]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t/2 using 1:2:10 title 'Full WF J_x(x,y,t)'; unset pm3d; unset view; unset colorbox; unset key;
