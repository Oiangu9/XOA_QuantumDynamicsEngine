...
psiIni="double sigmax=${sigmax}, sigmay=${sigmay}, mux=${mux}, muy=${muy}, kx=${k0}, ky=0; return pow(1.0/(2*PI*sigmax*sigmax),0.25)*exp(J*kx*x-0.25*pow((x-mux)/sigmax,2))* pow(1.0/(2*PI*sigmay*sigmay),0.25)*exp(J*ky*y-0.25*pow((y-muy)/sigmay,2));"
    ...
    START_TIME=$SECONDS
        ...
        set origin -0.007,0.0; set size 0.167, 0.33; clear; set key title 'R^4 G_x(x,y,t) for this trajectory KA y(t)'; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-2e-7<*:*<1e-6]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t using 1:2:3 title 'Full WF R^4 G_x(x,y,t)'; unset pm3d; unset view; unset colorbox; unset key;
        ...
        set origin 0.167,0.0; set size 0.166, 0.33; clear;  set xtics auto; set key title 'R^4 J_x(x,y,t) for this trajectory KA y(t)' at 1,39; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-1e-6<*:*<2e-7]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t using 1:2:4 title 'Full WF R^4 J_x(x,y,t)'; unset pm3d; unset view; unset colorbox; unset key;
        ...
        set origin 0.65,0.66; set size 0.166, 0.33; clear; set xtics auto; set key title 'R^2 dS_{dy}' at 1,39; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.01<*:*<0.01]; set colorbox user origin 0.795,0.72 size 0.005,0.23; splot 'DATA_Full_WF_G_J_CN.txt' index t using 1:2:5 title 'Full WF R^2 dS_{dy}'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.65,0.33; set size 0.167, 0.33; clear; set xtics auto; set key title 'R^2 d2S_{dy}' at 1,39; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.01<*:*<0.01]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t using 1:2:6 title 'Full WF R^2 d2S_{dy}'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.825,0.66; set size 0.166, 0.33; clear; set xtics auto; set key title 'dR_{dy}' at 1,39; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.01<*:*<0.01]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t using 1:2:7 title 'Full WF dR_{dy}'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.825,0.33; set size 0.167, 0.33; clear; set xtics auto; set key title 'd2R_{dy}' at 1,39; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.01<*:*<0.01]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t using 1:2:8 title 'Full WF d2R_{dy}'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.65,0.0; set size 0.166, 0.33; clear; set xtics auto; set key title 'G_x(x,y,t)' at 1,39; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.08<*:*<0.08]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t using 1:2:9 title 'Full WF G_x(x,y,t)'; unset pm3d; unset view; unset colorbox; unset key;
        set origin 0.825,0.0; set size 0.167, 0.33; clear; set xtics auto; set key title 'J_x(x,y,t)' at 1,39; set palette rgbformulae 33,13,10; set pm3d map; set xrange [$x1min:$x1max]; set yrange [$x2min:$x2max]; set xlabel 'Position x'; set ylabel 'Position y'; set cbrange[-0.08<*:*<0.08]; set colorbox; splot 'DATA_Full_WF_G_J_CN.txt' index t using 1:2:10 title 'Full WF J_x(x,y,t)'; unset pm3d; unset view; unset colorbox; unset key;
